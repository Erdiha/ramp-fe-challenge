    ...
    try {
      switch (endpoint) {
        case "employees":
          ...
          setTimeout(() => {
            mockApiLogger({ data: { endpoint, params, result }, message: "Loading employees..." })
            resolve(result)
          }, mockTimeout)
          break
        ...
        case "paginatedTransactions":
          ...
          setTimeout(() => {
            mockApiLogger({ data: { endpoint, params, result }, message: "Paginating Transactions..." })
            resolve(result)
          }, mockTimeout * 2.5)
          break
        ...
        case "transactionsByEmployee":
          ...
          setTimeout(() => {
            mockApiLogger({ data: { endpoint, params, result }, message: "Transactional Employee..." })
            resolve(result)
          }, mockTimeout * 1.5)
          break
        ...
        case "setTransactionApproval":
          ...
          //console.log("this is result in fakefetch", result)
          setTimeout(() => {
            mockApiLogger({ data: { endpoint, params, result }, message: "Transactional Approval..." })
            resolve(result)
          }, mockTimeout * 1)
          break
